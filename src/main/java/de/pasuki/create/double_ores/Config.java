...
public class Config {
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_CRUSHING_IRON_EXTRA_DROP_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_CRUSHING_GOLD_EXTRA_DROP_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_CRUSHING_COPPER_EXTRA_DROP_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_CRUSHING_ZINC_EXTRA_DROP_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_CRUSHING_EXPERIENCE_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue RAW_ORE_BLOCK_CRUSHING_IRON_EXTRA_DROP_CHANCE = BUILDER
            .translation("create_double_ore.configuration.rawOreBlockCrushing.ironExtraDropChance")
            .defineInRange("ironExtraDropChance", 0.5D, 0.0D, 1.0D);

    public static final ForgeConfigSpec.DoubleValue RAW_ORE_BLOCK_CRUSHING_GOLD_EXTRA_DROP_CHANCE = BUILDER
            .translation("create_double_ore.configuration.rawOreBlockCrushing.goldExtraDropChance")
            .defineInRange("goldExtraDropChance", 0.5D, 0.0D, 1.0D);

    public static final ForgeConfigSpec.DoubleValue RAW_ORE_BLOCK_CRUSHING_COPPER_EXTRA_DROP_CHANCE = BUILDER
            .translation("create_double_ore.configuration.rawOreBlockCrushing.copperExtraDropChance")
            .defineInRange("copperExtraDropChance", 0.5D, 0.0D, 1.0D);

    public static final ForgeConfigSpec.DoubleValue RAW_ORE_BLOCK_CRUSHING_ZINC_EXTRA_DROP_CHANCE = BUILDER
            .translation("create_double_ore.configuration.rawOreBlockCrushing.zincExtraDropChance")
            .defineInRange("zincExtraDropChance", 0.5D, 0.0D, 1.0D);

    public static final ForgeConfigSpec.DoubleValue RAW_ORE_BLOCK_CRUSHING_EXPERIENCE_CHANCE = BUILDER
